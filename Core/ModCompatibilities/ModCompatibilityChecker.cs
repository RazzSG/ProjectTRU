...
public class ModCompatibilityChecker : ModSystem
{
    ...
    [
        ...
        new("InfernumMode", new Version(2, 0, 1, 26), TRuConfig.Instance.InfernumModeLocalization),
        new("NoxusBoss", new Version(1, 2, 30), TRuConfig.Instance.NoxusBossLocalization),
        new("Redemption", new Version(0, 8, 0, 4120), TRuConfig.Instance.RedemptionLocalization),

...
public class ModCompatibilityChecker : ModSystem
{
    ...
    [
        new("CalamityMod", new Version(2, 0, 6), TRuConfig.Instance.CalamityModLocalization),
        ...
        new("FargowiltasSouls", new Version(1, 7, 3, 4), TRuConfig.Instance.FargowiltasSoulsLocalization),

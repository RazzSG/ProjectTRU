...
public class ModCompatibilityChecker : ModSystem
{
    private readonly ModCompatibilityInfo[] _modCompatibilityInfo =
    {
        ...
        new("FargowiltasSouls", new Version(1, 7, 2), TRuConfig.Instance.FargowiltasSoulsLocalization, true),
        new("Fargowiltas", new Version(3, 3, 6), TRuConfig.Instance.FargowiltasLocalization, true),

...
public class ModCompatibilityChecker : ModSystem
{
    ...
    [
        ...
        new("Fargowiltas", new Version(3, 3, 6, 3), TRuConfig.Instance.FargowiltasLocalization),
        new("FargowiltasSouls", new Version(1, 7, 3, 2), TRuConfig.Instance.FargowiltasSoulsLocalization),
        ...
        new("Redemption", new Version(0, 8, 0, 4082), TRuConfig.Instance.RedemptionLocalization),
        new("SpiritReforged", new Version(0, 1, 2, 3), TRuConfig.Instance.SpiritReforgedLocalization),
        new("StarsAbove", new Version(2, 1, 7, 3), TRuConfig.Instance.StarsAboveLocalization),
        new("ThoriumMod", new Version(1, 7, 2, 4), TRuConfig.Instance.ThoriumModLocalization)
    ];

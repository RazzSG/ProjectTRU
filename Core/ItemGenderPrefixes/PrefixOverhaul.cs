...
public class PrefixOverhaul
{
    ...
    public readonly string[][] Prefixes =
    {
        ...
        new [] {"Удручённый", "Удручённая", "Удручённое", "Удручённые"},
        new [] {"Подавленный", "Подавленная", "Подавленное", "Подавленные"},
        new [] {"Решительный", "Решительная", "Решительное", "Решительные"},
        new [] {"Неистовый", "Неистовая", "Неистовое", "Неистовые"},
        new [] {"Радостный", "Радостная", "Радостное", "Радостные"},
        new [] {"Мрачный", "Мрачная", "Мрачное", "Мрачные"},
        new [] {"Невредимый", "Невредимая", "Невредимое", "Невредимые"},
        new [] {"Раздражённый", "Раздражённая", "Раздражённое", "Раздражённые"},
        new [] {"Жизнерадостный", "Жизнерадостная", "Жизнерадостное", "Жизнерадостные"},
        new [] {"Преданный", "Преданная", "Преданное", "Преданные"},
        new [] {"Непоколебимый", "Непоколебимая", "Непоколебимое", "Непоколебимые"},
        new [] {"Непреклонный", "Непреклонная", "Непреклонное", "Непреклонные"},
        new [] {"Раздосадованный", "Раздосадованная", "Раздосадованное", "Раздосадованные"}
    };

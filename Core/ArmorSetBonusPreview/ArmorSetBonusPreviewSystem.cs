...
public class ArmorSetBonusPreviewSystem : ModSystem
{
    ...
    private void AddThoriumArmorSetBonuses()
    {
        if (ModInstances.Thorium != null)
        {
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/SpiritTrapperHelmet")] = "Увеличивает призываемое число миньонов на 1\nУбийство врагов или непрерывное нанесение урона боссам создаёт огоньки души\nПосле накопления 5 огоньков, они мгновенно поглощаются и восстанавливают 10 единиц здоровья";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/SpiritTrapperMask")] = "Увеличивает призываемое число стражей на 1\nУбийство врагов или непрерывное нанесение урона боссам создаёт огоньки души\nПосле накопления 5 огоньков, они мгновенно поглощаются и восстанавливают 10 единиц здоровья";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/TitanHeadgear")] = "Увеличивает наносимый урон на 18%";

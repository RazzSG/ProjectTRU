...
public class ArmorSetBonusPreviewSystem : ModSystem
{
    ...
    private void AddThoriumArmorSetBonuses()
    {
        ...
        {
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/WhisperingHood")] = "Периодически создаёт щупальце бездонной энергии, которое атакует ближайших врагов\nВы можете иметь до шести щупалец, а их атаки похищают у поражённого врага по 1 единице здоровья и маны";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/FlightMask")] = "Позволяет кратковременно летать";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/YewWoodHelmet")] = "После четырёх не критических ударов ваша следующая стрелковая атака нанесёт мини-критический удар с уроном в 150%\nМини-критические выстрелы считаются критическими ударами для соответствующих эффектов";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/MaestroWig")] = "Нажатие клавиши 'Способность брони' призывает хор призрачных музыкантов\nПризраки быстро атакуют ближайших врагов, используя духовые, деревянные, струнные и ударные инструменты";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/MarchingBandCap")] = "Когда вы находитесь в бою, за вами следует радуга наносящих урон симфонических символов, которые следуют за вами и оглушают врагов";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/NoblesHat")] = "Выпадающие ноты вдохновения становятся вдвое мощнее и временно увеличивают ваш симфонический урон";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/OrnateHat")] = "Симфонические критические удары усиливают случайное активное усиление до четвёртого уровня\nЭтот эффект может срабатывать не чаще одного раза в 5 секунд";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/MasterArbalestHood")] = "Ваш стрелковый урон с 10% шансом полностью продублируется и нанесёт на 15% больше урона";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/CoralHelmet")] = "Лучезарный урон накапливает до 20 единиц жизненного щита, и щит больше не истощается\nИсцеление союзника передаёт ему жизненный щит";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/TideHunterCap")] = "Стрелковые критические удары выпускают всплеск пены, замедляющий ближайших врагов";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/FeralFurHead")] = "Выглядите отлично!";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/SilkHat")] = "Увеличивает магический урон на 12%, если максимальный уровень маны превышает 90%";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/GeodeHelmet")] = "Теперь можно добывать целые рудные жилы сразу";
            ...
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/BlueKnightHelmet")] = "Выглядите отлично!";
            ArmorSetBonuses[TranslationHelper.GetItemID("ThoriumMod/GlitteringHelmet")] = "Выглядите отлично!";
        }
    }

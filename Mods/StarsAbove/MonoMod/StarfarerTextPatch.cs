...
public class StarfarerTextPatch : ILPatcher
{
    ...
    public override MethodInfo ModifiedMethod => ModInstances.StarsAbove.Code.GetType("StarsAbove.UI.Starfarers.StarfarerText").FindMethod("Update");

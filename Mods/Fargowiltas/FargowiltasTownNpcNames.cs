...
public class FargowiltasTownNpcNames : GlobalNPC
{
    private static Dictionary<int, List<string>> _townNpcNames = new()
    {
        { ModContent.NPCType<Abominationn>(),
            ["Вилта", "Джек", "Харли", "Жнец", "Стивенн", "Дуф", "Бару", "Фергус", "Энтев", "Катастроф", "Бардо", "Бетсон"]
        },
        ...
        { ModContent.NPCType<Mutant>(),
            ["Флакен", "Дорф", "Бинго", "Ханс", "Фарго", "Грим", "Майк", "Фаргу", "Терренс", "Кэтти Н. Пэм", "Том", "Вердус", "Полли"]
        },
        { ModContent.NPCType<Squirrel>(),
            ["Рик", "Жёлудь", "Пуфф", "Коко", "Трюфель", "Фурго", "Пискун"]
        }
    };

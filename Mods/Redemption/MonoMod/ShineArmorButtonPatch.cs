...
public class ShineArmorButtonPatch : ILPatcher
{
    ...
    public override MethodInfo ModifiedMethod => typeof(ShineArmorButton).FindMethod(nameof(ShineArmorButton.ModifyPosition));

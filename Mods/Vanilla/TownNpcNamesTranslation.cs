...
public class TownNpcNamesTranslation : GlobalNPC
{
    private static readonly Dictionary<int, Dictionary<string, string>> _townNpcNames = new()
    {
        ...
        [NPCID.ArmsDealer] = new Dictionary<string, string>
        {
            ...
            {"Jeffred", "Джеффред"},
            {"The Cooler Arthur", "Артур покруче"},
            {"Shark", "Шарк"},
            {"Sagi", "Саги"},
            {"Jongler", "Жонглёр"},
        },
        ...
        [NPCID.Wizard] = new Dictionary<string, string>
        {
            ...
            {"Jimbo Baggins", "Джимбо Бэггинс"},
            {"Shaby Morbals", "Шэбби Морбалс"},
        },
        ...
        [NPCID.TownDog] = new Dictionary<string, string>
        {
            ...
            {"Brikwilla", "Бриквилла"},
            {"Melody", "Мелоди"},
            {"Lord Foog the 2st", "Лорд Фуг 2-ый"},
            {"Kendra", "Кендра"},
            {"Yoshi", "Йоши"},
            {"Riley", "Райли"},
            {"Splinter", "Сплинтер"},
        ...
        {
            {"Smoogle", "Смоугл"},
            {"The Meowurer of Gods", "Мяукатель богов"},
        ...
        [NPCID.TownBunny] = new Dictionary<string, string>
        {
            {"Poco", "Поко"},
            {"Puffer", "Пуффер"},
            {"W53 Nuclear Bomb", "Ядерная бомба W53"},
        },
